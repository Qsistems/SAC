...
$.ajax({
		...
		type : "GET",
		url : "http://chd-pc:8080/SAC/rest/consulta/listaPlayList2",
		data : "{}",
		contentType : "application/json; charset=utf-8",
		dataType : "json",
		success : function(response) {
...
$(document).ready(function(){
	...
	var nombrePlayListSeleccionado= $("#cbPlayList :selected").text();
//---------- VALIDACION DE QUE EXISTA PROGRAMACION CREADA PARA ESTE PLAYLIST-------
	...
	$.ajax({
		...
		$.each(response, function(index, product) {
			...
			if(nombrePlayListSeleccionado == response[index].programacion_nombre)
				{
			     alert("EL PLAYLIST QUE ACABA DE SELECCIONAR TIENE YA UNA PROGRAMACIÓN DE HORARIO ASOCIADO, PUEDES MODIFICAR LA PROGRAMACION DESDE LA OPCIÓN EDITAR.");
			     location.reload();
				}
			else
				{
...
<table border="1">
<tr>
        <td colspan="2" style="text-shadow:1px 1px 1px rgba(0,0,0,1);BACKGROUND-COLOR: #457598;font-weight:normal;color:#ffffff;letter-spacing:1pt;word-spacing:12pt;font-size:18px;text-align:center;font-family:palatino linotype, palatino, serif;line-height:2;">CREACION DE PROGRAMACION DE PLAYLIST</td>

</tr>
<tr>
<td>

<form name="registro_Programacion" method="post" action="CreateProgram">
...
<table id="interno">
    ...
    <tr>
        <td> <label id="dis"></label><br> <span id="spanuser"><strong>SELECCIONE PLAYLIST:</strong></span> </td> 
		<td> <select name="cbPlayList" id="cbPlayList" >
   ...
   <!--  <tr>
        <td  style="vertical-align:middle;"> <label id="dis"></label><br> <span id="spanuser"><strong>NOMBRE PROGRAMACION</strong></span> </td> 
	    <td >  <input type="text" maxlength="20" name="nombreProgramacion" id="nombreProgramacion" /><br /> </td> 
	</tr> -->
   ...
   <!--  <tr>
    <td colspan="6">Se debe crear las lista de reproduccion, para en lo posterior darle uso en la publicacion de contenido web.</td>
    </tr>
    --> 
...
<iframe name="backgroundExecute" style="display: none;"></iframe>
		...
		<tr>
        	...
        	<td>
        	<a href="modificarProgramacionHoraria.jsp"><IMG SRC="images/button/modificarprogramacion.png" WIDTH=50 HEIGHT=50 ALT="Consultar" onclick="index.jsp"></a>
        ...
        <tr>
        	<td>
        	<string>! IMPORTANTE !</string> PUEDE EDITAR LA PROGRAMACION DE PLAYLIST,MODIFICAR LA REPRODUCCION DEL CONTENIDO MULTIMEDIA.
       		</td>
        </tr>
        <tr>	
         	<td colspan="4">
        	<IMG src="images/publicidad1.jpg" WIDTH=350 HEIGHT=100>
        	</td>
        </tr>
