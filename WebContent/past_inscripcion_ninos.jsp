...
<script
	...
	<form name="insniños" method="post" action="Insert_Inscripcion_Ninos">
		<center>
			<table>
				<tr>
				...
				<tr>
					<td>Nombre</td>
					<td><input type="text" name="nomb_repre" maxlength="50" required>
					</td>
					<td>Apellido</td>
					<td><input type="text" name="ape_repre" maxlength="50" required>
					</td>
				</tr>
				<tr>
					<td>Parentesco</td>
				...
				<tr>
					...
					<th COLSPAN="4">Datos Adicionales</th></tr>
