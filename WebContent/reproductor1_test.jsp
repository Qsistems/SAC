...
//------------- FECHA DEL DIA --------------------	
	...
	//------------------------------------------------
  	$.ajax({
		...
		if(response[index].link_nombre == 'LINK_URL_1' && hoy >= response[index].programacion_fecha_inicio && hoy <= response[index].programacion_fecha_fin)
			{  
...
<!-- <label id="info"></label> -->
<video  width="1279" height="799" autoplay controls muted loop=true>
