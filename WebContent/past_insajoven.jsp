...
$("#country_id").change(function() {
	$.ajax({
        ...
        success: function (response) {
        	...
        	//alert(response[3].nombre);

//var productt = response.Cedula;
$.each(response, function (index, product) {
	$("<option></option>")
	.attr("value", response[index].nombre).text(response[index].apellido)
	.appendTo('#coord'); 
	...
	<CENTER>
		<h1>REGISTRO DE PASTORAL PARA JOVENES</h1>
	</CENTER>
	<form name="insniños" method="post" action="InsertInscNinos">
		<center>
			<table>
				...
				<tr>
					<td>Parentesco</td>
					<td><input type="text" name="parent" maxlength="10" required>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select name="state_ref" id="coord">
							<option></option>
					</select></td>
				</tr>
				
					<td>Nombre Grupo</td>
					<td><select name="state_ref" id="nomb_grup">
							<option></option>
					</select></td>
				</tr>
				<tr>
					<td>Dias</td>
					<td><select name="state_ref" id="dias">
							<option></option>
					</select>
					</td>
					<td>Año</td>
					<td><select name="state_ref" id="anio">
							<option></option>
					</select></td>
				</tr>
				<tr>
					<td>Hora Inicio</td>
					<td><select name="state_ref" id="hora_ini">
							<option></option>
					</select></td>

					<td>Hora Fin</td>
					<td><select name="state_ref" id="hora_fin">
							<option></option>
					</select></td>
				</tr>
			</table>
