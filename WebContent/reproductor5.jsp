...
//------------------------------------------------
  	...
  	$.ajax({
		...
		if(response[index].link_nombre == 'LINK_URL_5' && hoy >= response[index].programacion_fecha_inicio && hoy <= response[index].programacion_fecha_fin)
			{   
