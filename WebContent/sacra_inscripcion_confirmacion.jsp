		...
		<h1> Inscripciones de Comunión</h1>
			<table>
				...
				<tr>
					...
					<td><input type="text" name="naci" ></td>
					<td>Edad:</td>
				...
				<tr>
					...
					<td>Convencional</td>
					<td><input type="text" name="convencional" >
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="Pbautizo"></td>
					<td>Fé de Bautizo</td>
					<td><select name="group">
							<option>SI</option>
							<option>NO</option>
