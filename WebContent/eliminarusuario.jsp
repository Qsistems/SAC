...
<body>
	<div id="user">
		...
		<form name="frmuser" method="post" action="ElimUser">
			<center>
				<table>
					<tr>
						<td colspan=2>
					...
					<tr>
						<td>Nombres:</td>
						<td><input type="text" name="nombre" maxlength="50" readonly = "readonly">
						</td>
					</tr>
					<tr>
						<td>Apellidos:</td>
						<td><input type="text" name="apellido" maxlength="50"readonly = "readonly"></td>
					</tr>
					<tr>
						<td>Usuario:</td>
					...
					<tr>
						<td>Contraseña:</td>
						<td><input type="text" name="contraseña" readonly = "readonly">
						</td>
					</tr>
					<tr>
						<td>Edad:</td>
						<td><input type="text" name="edad" maxlength="2" readonly = "readonly">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							<button type="submit" name="formusuario" value="eliminar">ELIMINAR</button>
						</td>
					</tr>
				</table>
			</center>
